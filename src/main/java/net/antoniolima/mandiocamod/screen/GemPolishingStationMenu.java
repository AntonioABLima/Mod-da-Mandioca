package net.antoniolima.mandiocamod.screen;

import net.antoniolima.mandiocamod.block.ModBlocks;
import net.antoniolima.mandiocamod.block.entity.GemPolishingStationBlockEntity;
...
public class GemPolishingStationMenu extends AbstractContainerMenu {
    ...
    public ItemStack quickMoveStack(Player playerIn, int pIndex) {
        ...
        System.out.println(copyOfSourceStack);
