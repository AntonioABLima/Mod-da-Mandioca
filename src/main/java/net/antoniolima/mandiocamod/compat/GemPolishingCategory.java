package net.antoniolima.mandiocamod.compat;
...
import net.antoniolima.mandiocamod.recipe.GemPolishingRecipe;
import net.minecraft.network.chat.Component;
import net.minecraft.resources.ResourceLocation;
import net.minecraft.world.item.ItemStack;

public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(MandiocaMod.MOD_ID, "gem_polishing");
    public static final ResourceLocation TEXTURE = new ResourceLocation(MandiocaMod.MOD_ID,
    ...
    public Component getTitle() {
        return Component.translatable("block.mandiocamod.gem_polishing_station");
    }
